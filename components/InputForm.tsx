                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    <label className="flex items-center gap-2 cursor-pointer group">
                      <div className={`w-5 h-5 rounded-full border flex items-center justify-center ${formData.targetDateType === 'planting' ? (isDarkMode ? 'border-emerald-400 bg-emerald-950/80' : 'border-emerald-600 bg-white') : (isDarkMode ? 'border-emerald-800 bg-emerald-950/60' : 'border-emerald-300 bg-white')}`}>
                    ...
                    <label className="flex items-center gap-2 cursor-pointer group">
                      <div className={`w-5 h-5 rounded-full border flex items-center justify-center ${formData.targetDateType === 'harvest' ? (isDarkMode ? 'border-emerald-400 bg-emerald-950/80' : 'border-emerald-600 bg-white') : (isDarkMode ? 'border-emerald-800 bg-emerald-950/60' : 'border-emerald-300 bg-white')}`}>
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                      ...
                      />
                      <div className={`w-10 h-5 ${isDarkMode ? 'bg-emerald-900' : 'bg-gray-300'} peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all ${sprinkler.enabled ? 'peer-checked:bg-emerald-500' : 'peer-checked:bg-emerald-500'}`}></div>
                    </label>
                  </div>
